...
class TestsControllerTest < ActionController::TestCase
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post :create, test: { date: @test.date, member_id: @test.member_id, result: @test.result }
    end
  ...
  test "should update test" do
    patch :update, id: @test, test: { date: @test.date, member_id: @test.member_id, result: @test.result }
    assert_redirected_to test_path(assigns(:test))
  end
